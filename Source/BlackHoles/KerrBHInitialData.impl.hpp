                              ...
                              const amrex::Array4<amrex::Real> &state) const
{
    ...
    // transforms
    auto h     = spherical_to_cartesian_LL(spherical_g, x, y, z);
    auto A     = spherical_to_cartesian_LL(spherical_K, x, y, z);
    auto shift = spherical_to_cartesian_U(spherical_shift, x, y, z);
...
AMREX_FORCE_INLINE AMREX_GPU_DEVICE void 
KerrBHInitialData::compute_kerr(Tensor::Rank2 &spherical_g,
                                Tensor::Rank2 &spherical_K,
                                Tensor::Rank1 &spherical_shift,
                                amrex::Real &kerr_lapse,
